...
<a href="http://github.com/marak/Faker.js/"><img style="position:absolute;  z-index:10; top: 0; right: 0; border: 0;"
...
<strong>protip</strong>: open your console on this page and run: <code>console.log(Faker); var randomName =
    Faker.Name.findName(); console.log(randomName);</code>
<hr/>
<div id="output"></div>
</body>
</html>
